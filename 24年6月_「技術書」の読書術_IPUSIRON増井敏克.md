...
# 選んだ理由
- 技術書に特化した読書術は珍しいので興味を感じたため
- 学習を進める上で読書のスキルを上げることは不可欠であるため

# 感想
- 読書で効率を求めている自分に気付かされ、意識を変えていく必要があると痛感させられた
- 本を読む目的を明確にし、多くの本に触れていこうと感じた
...
## ３日後の自分は他人
- プログラミングにおいて、ドキュメントを作成したり、ソースコード中に実装した理由などをコメントとして書いておくことが推奨される
